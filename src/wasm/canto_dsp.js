...
export class Analyzer {
    ...
    analyze(samples) {
        ...
        const ret = wasm.analyzer_analyze(this.__wbg_ptr, ptr0, len0);
     ...
     * @param {number} size
     */
    constructor(sample_rate, size) {
        const ret = wasm.analyzer_new(sample_rate, size);
        this.__wbg_ptr = ret;
...
async function __wbg_init(module_or_path) {
    ...
    if (module_or_path === undefined) {
        module_or_path = new URL('canto_dsp_bg.wasm', import.meta.url);
    }
    const imports = __wbg_get_imports();
